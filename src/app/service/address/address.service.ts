...
export class AddressService {
  ...
  getDistance(body,headers) {
    return this.httpClient.post(GlobalConstants.APIEndPointCustomer + 'get-distance',body,{ headers })
  }
  Booknow(body,headers) {
    return this.httpClient.post(GlobalConstants.APIEndPointCustomer + 'booknow',body,{ headers })
  }
