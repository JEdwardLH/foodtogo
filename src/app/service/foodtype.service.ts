...
export class FoodtypeService {
  ...
  cancelRecommend(body,headers) {
    return this.httpClient.post(GlobalConstants.APIEndPointCustomer + 'cancel-order-recommendation',body,{ headers })
  }
  quickProduct(body,headers) {
    return this.httpClient.post(GlobalConstants.APIEndPointCustomer + 'quck-product-view',body,{ headers })
  }
}
